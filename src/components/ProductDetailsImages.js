  ...
  return (
    ...
    <div className="item-1">
        ...
        <div className="item-1-prod-images">
         <div className="item-1"> <img src= {"https://images.pexels.com/photos/1299391/pexels-photo-1299391.jpeg?cs=srgb&dl=pexels-david-dibert-1299391.jpg&fm=jpg"}  alt={params.name} /></div>
